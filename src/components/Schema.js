...
function Schema() {
  ...
  const handleConvertToSql = async () => {
    ...
    try {
      ...
      const response = await fetch(API_ENDPOINTS.GENERATE_SCHEMA, {
        method: "POST",
  ...
  const handleGenerateSql = async () => {
    ...
    setIsExporting(true);
    try {
      const response = await fetch(API_ENDPOINTS.GENERATE_SCHEMA_SQL, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleGenerateJson = async () => {
    ...
    setIsExporting(true);
    try {
      const response = await fetch(API_ENDPOINTS.GENERATE_SCHEMA_JSON, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ 
